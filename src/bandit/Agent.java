...
public abstract class Agent {
	...
	public List<Double> getTotalRewardData() {
		return totalRewardData;
	}

	public List<Double> getAccuracyRateData() {
		return accuracyRateData;
	}

	public List<Double> getTotalRegretData() {
		return totalRegretData;
	}
